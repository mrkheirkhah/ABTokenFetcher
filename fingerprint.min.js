  ...
  return (
    (t.prototype = {
      get: function () {
        ...
        return (
          ...
          this.canvas &&
            ...
            t.push(this.getCanvasFingerprint()),
          this.hasher
      ...
      murmurhash3_32_gc: function (t, e) {
        ...
        switch (((h = 0), n)) {
          case 3:
            h ^= (255 & t.charCodeAt(c + 2)) << 16;
          case 2:
            h ^= (255 & t.charCodeAt(c + 1)) << 8;
          case 1:
            i ^= h =
              ((65535 &
                (h =
                  ((h =
                    ((65535 & (h ^= 255 & t.charCodeAt(c))) * o +
                      ((((h >>> 16) * o) & 65535) << 16)) &
                    4294967295) <<
                    15) |
                  (h >>> 17))) *
